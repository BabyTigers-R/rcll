...
class btr_2024(object):
    def __init__(self, topicName):
        ...
        self.sub1 = rclpy.Subscription(self.topicName + "/odom", Odometry, self.myagvOdometry)
        self.sub3 = rclpy.Subscription(self.topicName + "/btr/centerPoint", Point, self.centerPoint)
        self.sub4 = rclpy.Subscription(self.topicName + "/btr/leftPoint", Point, self.leftPoint)
        self.sub5 = rclpy.Subscription(self.topicName + "/btr/rightPoint", Point, self.rightPoint)
        self.sub6 = rclpy.Subscription(self.topicName + "/btr/forwardPoint", Point, self.forwardPoint)
        self.rate = rclpy.Rate(10)
        self.pub1 = rclpy.Publisher(self.topicName + "/cmd_vel", Twist, queue_size = 10)
    ...
    def w_resetOdometry(self, data):
        ...
        pose = Pose2D()
        rclpy.wait_for_service(self.topicName + '/reset_odometry')
        resetOdometry = rclpy.ServiceProxy(self.topicName + '/reset_odometry', ResetOdometry)
    ...
    def w_goToInputVelt(self):    # 375mm from left side(= 25 + 50*7)
        ...
        # self.w_myagvMove(0, 0.030)
        self.w_myagvMove(0, -0.020)
        # self.w_goToWall(15)
    ...
    def w_turnClockwise(self):
        ...
        self.w_myagvMove(0.7, 0, -90, quick = True)
        self.w_myagvMove(1.2, 0, -90, quick = True)
        self.w_myagvMove(0.7, 0, -90, quick = True)
...
if __name__ == '__main__':
  ...
  rclpy.init_node('btr2024')
  agent = btr_2024("myagv")
  # while True:
