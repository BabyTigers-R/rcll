...
class btr_2024(Node):
    def __init__(self, topicName):
        ...
        self.sub1 = self.create_subscription(msg_type,topic,callback,qos)
        self.sub3 = self.create_subscription(Point,self.topicName + "/btr/centerPoint", self.centerPoint,qos)
        self.sub4 = self.create_subscription(Point,self.topicName + "/btr/leftPoint",self.leftPoint,qos)
        self.sub5 = self.create.subscription(Point,self.topicName + "/btr/rightPoint",self.rightPoint,qos)
        self.sub6 = rclpy.Subscription(self.topicName + "/btr/forwardPoint", Point, self.forwardPoint,qos)
        self.rate = rclpy.Rate(10)
        self.pub1 = self.create.Publisher(Twist,"/cmd_vel", Twist, qos)
